...
# Save plots
ggsave("output/predicted_probabilities.png", width = 10, height = 6)
ggsave("output/first_differences.png", width = 10, height = 6)
ggsave("output/separation_plots.png", width = 10, height = 6)
